...
wall-clock seconds per independent configuration for each arm.
    ...
    python u1_2d/scripts/14_diffusion_vs_instanton_hmc.py \
        --config u1_2d/configs/v2.yaml [--smoke]
"""
...
from u1_2d.lgt.hmc import BatchedHMC, adapted_hmc_params, run_hmc_ensemble
from u1_2d.lgt.lattice import plaquette_angles, topological_charge, wilson_loop_angles
from u1_2d.lgt.local_updates import retherm_sweeps, topological_update
...
from u1_2d.utils import load_config, resolve_device, set_seed, save_json, save_ensemble
