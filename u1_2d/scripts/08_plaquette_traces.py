...
window, for visualization only.
    ...
    python u1_2d/scripts/08_plaquette_traces.py --dir out/u1_2d/demo/thermalization
    python u1_2d/scripts/08_plaquette_traces.py --dir out/u1_2d/demo/thermalization/generalization
"""
...
from u1_2d.validate.stats import fit_exponential_relaxation
...
def main() -> None:
    ...
    parser.add_argument("--dir", default="out/u1_2d/demo/thermalization",
