...
P(Q) before / after / exact plus the <Q^2> convergence trajectory.
    ...
    python u1_2d/scripts/18_pq_hmc_tail.py --gen-dir out/u1_2d/generalization
"""
...
def main() -> None:
    ...
    parser.add_argument("--gen-dir", default="out/u1_2d/generalization")
