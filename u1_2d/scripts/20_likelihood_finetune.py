...
--checkpoint <out> afterwards: success = log_weight_std_fiber drops.
    ...
    .venv/Scripts/python.exe u1_2d/scripts/20_likelihood_finetune.py \
        --config u1_2d/configs/v2.yaml --steps 300
"""
...
from u1_2d.model.train import denoising_loss, load_checkpoint, _prepare_rung, RungData
