...
chain itself. All chains here run WITHOUT topological updates (plain HMC).
    ...
    python u1_2d/scripts/05_hmc_thermalization.py --config u1_2d/configs/demo.yaml
...
does thermalize, so 2 tau_int and burn-in are honest yardsticks:
    ...
    python u1_2d/scripts/05_hmc_thermalization.py --generalization
"""
...
def main() -> None:
    ...
    parser.add_argument("--config", default="u1_2d/configs/demo.yaml")
    ...
    parser.add_argument("--run-dir", default=None, dest="run_dir",
                        ...
                        "e.g. out/u1_2d/demo when the config says artifacts/diffusion/demo)")
    parser.add_argument("--generalization", nargs="?", const="out/u1_2d/demo/generalization",
                        default=None,
