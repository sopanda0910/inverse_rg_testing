...
are the topology yardstick.
    ...
    .venv/Scripts/python.exe u1_2d/scripts/run_ablation.py
"""
...
CONFIG = "u1_2d/configs/v2_ablate_norm.yaml"
OUT = REPO / "out" / "u1_2d" / "v2_ablate_norm"
STATE = OUT / "campaign_state"
GEN_DIR = OUT / "generalization"
MAIN_GEN = REPO / "out" / "u1_2d" / "generalization"
CKPT = "out/u1_2d/v2_ablate_norm/checkpoints/score_net.pt"
...
def main() -> None:
    ...
    run_stage("STUDY", [PY, "u1_2d/scripts/06_generalization_study.py",
