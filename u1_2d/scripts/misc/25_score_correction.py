...
Generalization protocol (the point of this design):
  ...
  * judged afterwards by fresh-seed script-19 verification on cases DISJOINT
    ...
    .venv/Scripts/python.exe u1_2d/scripts/25_score_correction.py --steps 200
"""
...
from u1_2d.model.likelihood import conditional_log_likelihood
from u1_2d.model.likelihood_train import ml_conditional_log_likelihood
from u1_2d.model.schedule import GeometricNoiseSchedule
from u1_2d.model.score_correction import CorrectedScore, save_correction
...
def main() -> None:
    ...
    parser.add_argument("--checkpoint", default="out/u1_2d/checkpoints/score_net_rkl2.pt")
    parser.add_argument("--out", default="out/u1_2d/checkpoints/score_correction.pt")
