...
them; observables missing from a series file are skipped.
    ...
    python u1_2d/scripts/11_autocorrelation.py --dir out/u1_2d/demo/thermalization
    python u1_2d/scripts/11_autocorrelation.py --obs plaquette,Q --max-lag 40
"""
...
from u1_2d.validate.stats import normalized_autocorrelation
