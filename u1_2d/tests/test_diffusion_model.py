...
from u1_2d.lgt import WilsonAction, random_gauge_transform, wrap
from u1_2d.lgt.lattice import plaquette_angles
from u1_2d.model.wrapped import (
...
from u1_2d.model.score_net import (
    GaugeCovariantScoreNet,
    coarse_conditioning_channels,
    invariant_channels,
    plaquette_curl,
)
from u1_2d.model.train import RungData, TrainConfig, denoising_loss, train_score_model
...
class TestCoarseChargeEnforcement:
    def test_instanton_shift_sets_fine_charge_to_coarse(self):
        ...
        from u1_2d.model.wrapped import wrap as wrap_angle
...
class TestTopoPenalty:
    def test_soft_charge_matches_integer_charge_on_smooth_configs(self):
        from u1_2d.lgt.local_updates import instanton_field
        from u1_2d.lgt.lattice import topological_charge
        from u1_2d.model.train import soft_topological_charge
...
class TestV6Machinery:
    ...
    def test_winding_channel_carries_charge(self):
        from u1_2d.lgt.local_updates import instanton_field
        from u1_2d.lgt.lattice import TWO_PI
    ...
    def test_checkpoint_roundtrip_with_v6_fields(self, tmp_path):
        from u1_2d.model.train import save_checkpoint, load_checkpoint
    ...
    def test_expand_rungs_deterministic_and_policied(self):
        from u1_2d.utils import expand_rungs
...
class TestPhysicsScoreBlend:
    def test_exact_score_matches_autograd(self):
        from u1_2d.pipeline.ladder import wilson_exact_score
...
class TestQDisplayWindow:
    def test_narrow_for_peaked_distribution(self):
        from u1_2d.validate.report import _q_display_window
...
class TestPlaquetteDisplayWindow:
    def test_narrow_for_peaked_density(self):
        from u1_2d.validate.report import _plaquette_display_window
