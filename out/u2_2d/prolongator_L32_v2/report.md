...
|---|---|---|---|---|---|---|---|---|
| tile | 0 | 4 | 0 | 0 | 4 | -1.46e-02 | 1.40e-05 | 5 |
| halve | 0 | 0 | 0 | 0 | 0 | -1.88e-01 | 1.08e-05 | 3 |
| flux | 0 | 0 | 6 | 0 | 6 | -9.48e-02 | 3.85e-05 | 3 |
| smear (20 sweeps) | 3 | 3 | 0 | 0 | 3 | -9.49e-02 | 7.24e-06 | 5 |
| hot | > 400 | > 400 | > 400 | > 400 | > 400 | -- | 1.00e+00 | 0 |
| cold | 157 | 130 | 151 | 48 | 157 | -- | 1.93e-02 | 0 |
| **diffusion** | **5** | **5** | **1** | **0** | **5** | +1.04e-04 | 2.75e-06 | 0 |

## What to read off it

**Pre-rethermalization the learned lift is 141x closer to exact than the best geometric arm** (`tile`): 1.04e-04 against 1.46e-02.
After the identical post-processing every arm receives, that margin is gone: at $t = 0$ the diffusion arm is 2.6x better than `smear` (2.75e-06 against 7.24e-06). The exact conditional SU(2) sampler repairs a bad determinant sector, so **local observables do not discriminate the lift.** Argue the model on topology and extended loops, not on the plaquette.
