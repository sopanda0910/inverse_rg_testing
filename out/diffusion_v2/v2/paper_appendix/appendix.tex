...
%          \usepackage{booktabs}
% Images expected at figures/01_ladder_drift.png ... figures/22_pq_tail_L64.png
% ===================================================================
...
are statistically identical in the two modes (mean plaquette $|z|$ 1.77 vs
1.74 over 38 cases).
...
\begin{figure}[p]
  ...
  $\langle Q^2 \rangle = 5.2$ vs exact 4.78 ($p = 0.43$) in 6 seconds of
...
\begin{table}[p]
  ...
  \begin{tabular}{lrr}
    ...
    cases with $|z(\langle Q^2 \rangle)| > 2$   & 13   & 3    \\
...
\begin{table}[p]
  ...
  \begin{tabular}{lrrrrrrrr}
    ...
    \midrule
    B\_bt6      & 32 & 6      & 1.92  & 5.20  & 4.78  & 0.0005 & 0.43 & 6  \\
