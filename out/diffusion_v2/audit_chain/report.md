...
- Validation report (tau_int-aware, raw pass): `out\diffusion_v2\validation\report.md`
- Campaign verdict (rerun): `out\diffusion_v2\verdict\verdict.md`
- L=64 head-to-head: `out\diffusion_v2\diffusion_vs_instanton\L64\report.md`