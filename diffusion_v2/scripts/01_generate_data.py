"""Generate HMC ensembles for all training + held-out rungs, plus beta matching.
    ...
    python diffusion_v2/scripts/01_generate_data.py --config diffusion_v2/configs/default.yaml
"""
...
from diffusion_v2.lgt import make_action, run_hmc_ensemble, block_links, match_coarse_beta
from diffusion_v2.lgt.blocking import villain_blocked_beta
from diffusion_v2.lgt.hmc import adapted_hmc_params
from diffusion_v2.lgt.lattice import wrap
from diffusion_v2.lgt.local_updates import instanton_field, retherm_sweeps
