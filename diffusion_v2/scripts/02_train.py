"""Train the conditional score model across all training rungs.
    ...
    python diffusion_v2/scripts/02_train.py --config diffusion_v2/configs/default.yaml
"""
...
from diffusion_v2.model.train import RungData, TrainConfig, train_score_model
...
def main() -> None:
    ...
    if heldout_rungs:
        ...
        from diffusion_v2.model.train import denoising_loss, _prepare_rung
