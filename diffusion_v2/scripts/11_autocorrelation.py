...
them; observables missing from a series file are skipped.
    ...
    python diffusion_v2/scripts/11_autocorrelation.py --dir out/diffusion_v2/demo/thermalization
    python diffusion_v2/scripts/11_autocorrelation.py --obs plaquette,Q --max-lag 40
"""
...
from diffusion_v2.validate.stats import normalized_autocorrelation
