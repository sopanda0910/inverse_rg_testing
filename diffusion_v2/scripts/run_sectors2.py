...
main directory before the aggregate report is rebuilt.
    ...
    .venv/Scripts/python.exe diffusion_v2/scripts/run_sectors2.py
"""
...
def study_cmd(out_dir, cases):
    return [PY, "diffusion_v2/scripts/06_generalization_study.py",
...
def merge():
    ...
    rc = subprocess.run([PY, "diffusion_v2/scripts/06_generalization_study.py",
...
def main():
    ...
    def pq_tail():
        rc = subprocess.run([PY, "diffusion_v2/scripts/18_pq_hmc_tail.py",
