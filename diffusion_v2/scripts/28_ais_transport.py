...
samples between increments. Machinery in diffusion_v2/model/ais.py; validity
...
Honesty protocol:
  ...
  * expectation set by the audit: wins at moderate beta; topological-sector
    ...
    python diffusion_v2/scripts/28_ais_transport.py --cases 16:14.1464 16:55.0237 32:55.0237
"""
...
def main() -> None:
    ...
    out_dir = Path(args.out or "out/diffusion_v2/ais_transport")
