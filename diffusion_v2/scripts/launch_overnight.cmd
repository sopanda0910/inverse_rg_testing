...
echo ================ overnight launch %date% %time% ================ >> "out\diffusion_v2\v2\overnight.log"
".venv\Scripts\python.exe" "diffusion_v2\scripts\run_overnight.py" >> "out\diffusion_v2\v2\overnight.log" 2>&1
