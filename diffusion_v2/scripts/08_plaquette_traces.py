...
window, for visualization only.
    ...
    python diffusion_v2/scripts/08_plaquette_traces.py --dir out/diffusion_v2/demo/thermalization
    python diffusion_v2/scripts/08_plaquette_traces.py --dir out/diffusion_v2/demo/thermalization/generalization
"""
...
from diffusion_v2.lgt import exact, make_action
...
from diffusion_v2.validate.stats import fit_exponential_relaxation
...
def main() -> None:
    ...
    parser.add_argument("--dir", default="out/diffusion_v2/demo/thermalization",
