...
out/diffusion_v2/demo/beta_matching/ (override with --dir).
...
from diffusion_v2.lgt.blocking import (
    block_links,
    blocked_character_exact,
    match_coarse_beta,
    matching_residuals,
)
from diffusion_v2.lgt.exact import (
...
from diffusion_v2.validate.report import GEN_COLOR, REF_COLOR, INK, MUTED, GRID_COLOR

OUT = Path("out/diffusion_v2/demo/beta_matching")
DATA_DIR = Path("out/diffusion_v2/demo/data")
...
def _finite_volume_match(target: float, coarse_l: int) -> float:
    from diffusion_v2.lgt.exact import plaquette_exact
