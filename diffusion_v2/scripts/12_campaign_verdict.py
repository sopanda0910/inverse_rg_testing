...
thermalization/ benchmark from 05 --generalization).
    ...
    .venv/Scripts/python.exe diffusion/scripts/12_campaign_verdict.py \
        --study out/diffusion_v2/demo_v6/generalization --train-range 1:60
    .venv/Scripts/python.exe diffusion/scripts/12_campaign_verdict.py \
        --study out/diffusion_v2/demo/generalization_v5 --train-range 1:60 \
        --baseline out/diffusion_v2/demo/generalization_v4
