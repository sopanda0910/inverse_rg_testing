...
Reads out/diffusion_v2/demo/generalization/summary.json (built by
...
from diffusion_v2.lgt.exact import plaquette_exact, string_tension_exact
from diffusion_v2.validate.report import GEN_COLOR, REF_COLOR, INK, MUTED, GRID_COLOR

OUT = Path("out/diffusion_v2/demo/generalization")
C_COLOR = "#8a63c9"
PART_STYLE = {
...
def fig_volume(recs: dict) -> None:
    ...
    from diffusion_v2.lgt.exact import wilson_loop_exact
