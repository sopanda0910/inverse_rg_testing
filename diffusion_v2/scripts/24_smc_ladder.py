...
propagating up the ladder wherever the per-level ESS is usable.
    ...
    python diffusion_v2/scripts/24_smc_ladder.py --n-configs 192
"""
...
def main() -> None:
    ...
    parser.add_argument("--checkpoint", default=None,
                        help="default: out/diffusion_v2/checkpoints/score_net_rkl2.pt")
    ...
    ckpt = args.checkpoint or "out/diffusion_v2/checkpoints/score_net_rkl2.pt"
    ...
    out_dir = Path(args.out or "out/diffusion_v2/ess_chain/smc_ladder")
