...
from diffusion_v2.lgt.lattice import plaquette_angles, mean_plaquette, wilson_loop_angles
...
from diffusion_v2.lgt.local_updates import (
    heatbath_sweep,
