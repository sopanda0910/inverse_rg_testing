...
from diffusion_v2.lgt import WilsonAction, random_gauge_transform, wrap
from diffusion_v2.lgt.lattice import plaquette_angles
from diffusion_v2.model.wrapped import (
...
from diffusion_v2.model.score_net import (
    GaugeCovariantScoreNet,
    coarse_conditioning_channels,
    invariant_channels,
    plaquette_curl,
)
from diffusion_v2.model.train import RungData, TrainConfig, denoising_loss, train_score_model
...
class TestBlockingConsistencyGuidance:
    def test_guidance_is_gauge_invariant_and_reduces_residual(self):
        from diffusion_v2.pipeline.ladder import blocking_consistency_score
        from diffusion_v2.lgt import block_links
        from diffusion_v2.lgt.lattice import plaquette_angles, wrap
...
class TestCoarseChargeEnforcement:
    def test_instanton_shift_sets_fine_charge_to_coarse(self):
        from diffusion_v2.lgt.local_updates import instanton_field
        from diffusion_v2.lgt.lattice import topological_charge
        from diffusion_v2.model.wrapped import wrap as wrap_angle
...
class TestTopoPenalty:
    def test_soft_charge_matches_integer_charge_on_smooth_configs(self):
        from diffusion_v2.lgt.local_updates import instanton_field
        from diffusion_v2.lgt.lattice import topological_charge
        from diffusion_v2.model.train import soft_topological_charge
...
class TestInSamplerChargeProjection:
    def test_sampler_step_callback_is_applied_each_step(self):
        from diffusion_v2.model.sampler import sample_ancestral
...
class TestV6Machinery:
    ...
    def test_winding_channel_carries_charge(self):
        from diffusion_v2.lgt.local_updates import instanton_field
        from diffusion_v2.lgt.lattice import TWO_PI
    ...
    def test_checkpoint_roundtrip_with_v6_fields(self, tmp_path):
        from diffusion_v2.model.train import save_checkpoint, load_checkpoint
    ...
    def test_expand_rungs_deterministic_and_policied(self):
        from diffusion_v2.utils import expand_rungs
...
class TestPhysicsScoreBlend:
    def test_exact_score_matches_autograd(self):
        from diffusion_v2.pipeline.ladder import wilson_exact_score
...
class TestQDisplayWindow:
    def test_narrow_for_peaked_distribution(self):
        from diffusion_v2.validate.report import _q_display_window
    ...
    def test_reference_label_reaches_the_legend(self, tmp_path):
        from diffusion_v2.validate.report import validate_ensemble
...
class TestPlaquetteDisplayWindow:
    def test_narrow_for_peaked_density(self):
        from diffusion_v2.validate.report import _plaquette_display_window
