...
from diffusion_v2.lgt.hmc import BatchedHMC
from diffusion_v2.lgt.lattice import (
    rectangle_x_angles,
    rectangle_y_angles,
    topological_charge,
    wilson_loop_angles,
...
from diffusion_v2.model.score_net import coarse_conditioning_channels
from diffusion_v2.validate.stats import (
...
class TestCertificateAndSectors:
    def test_certificate_identity_uniform_proposal(self):
        ...
        from diffusion_v2.model.likelihood import free_energy_certificate
