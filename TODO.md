# Check larger wilson loops and other observables (larger IR observables like Q, Q^2, and topological susceptability)
# Can this be generalized to any physical scale (start training at B=1, but can this be generalized to the vertical of Beta=2)
