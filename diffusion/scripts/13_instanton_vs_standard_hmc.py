...
from diffusion.lgt.actions import make_action
...
from diffusion.utils import load_ensemble, save_ensemble, save_json, set_seed
from diffusion.validate.observables import measure_ensemble
from diffusion.validate.report import (
...
OUT_DIR = Path("out/diffusion/demo_v6/instanton_vs_standard")
ACTION_TYPE = "wilson"
