# Wave 2: top rung 0 (L=32, beta=105.651). Two processes, run concurrently.
#
...
$local = Start-Process -PassThru -NoNewWindow -FilePath $py -ArgumentList @(
  "u2_2d/scripts/50_therm_autocorr.py","--rung","0",
  "--arms","diffusion_raw","diffusion_tuned","smear","ape","flux","cold",
  "--n-traj","600","--n-chains","64",
  "--out-dir","out/u2_2d/therm_autocorr_L32_local"
) -RedirectStandardOutput out/u2_2d/log_ta_L32_local.log -RedirectStandardError out/u2_2d/log_ta_L32_local.err

$topo = Start-Process -PassThru -NoNewWindow -FilePath $py -ArgumentList @(
  "u2_2d/scripts/50_therm_autocorr.py","--rung","0","--winding",
  "--arms","diffusion_raw","smear","cold",
  "--n-traj","400","--n-chains","64",
  "--out-dir","out/u2_2d/therm_autocorr_L32_topo"
) -RedirectStandardOutput out/u2_2d/log_ta_L32_topo.log -RedirectStandardError out/u2_2d/log_ta_L32_topo.err
